namespace Faultline.Core
{
    ...
    public enum TileType
    {
        ...
        /// <summary>Occupiable. Displaced onto: 3 damage. Walked onto voluntarily: 1 damage.</summary>
        Spikes = 3,

        /// <summary>Ranged attacks from here deal +1. Cannot be pushed up onto it.</summary>
        HighGround = 4,
