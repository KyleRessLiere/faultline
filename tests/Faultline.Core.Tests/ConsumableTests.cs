...
public class ConsumableTests
{
    ...
    [Fact]
    public void TheTacticalPool_IsTheFiveThatAreBuilt()
    {
        ...
        // built, and deliberately not sitting in the enum unreachable.
        Assert.Equal(5, Enum.GetValues(typeof(Consumable)).Length);
    }
